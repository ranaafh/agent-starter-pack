...
def parse_args() -> argparse.Namespace:
    ...
    # New Confluence-specific arguments
    parser.add_argument(
        "--confluence-domain",
        default=os.getenv("CONFLUENCE_DOMAIN"),
        help="Confluence domain (e.g. 'your-domain.atlassian.net')",
    )
    parser.add_argument(
        "--confluence-email",
        default=os.getenv("CONFLUENCE_EMAIL"),
        help="Confluence email",
    )
    parser.add_argument(
        "--confluence-token",
    ...
    parser.add_argument(
        "--confluence-page-ids",
        default=os.getenv("CONFLUENCE_PAGE_IDS"),
        help="Comma-separated list of Confluence page IDs",
    )
    ...
    required_params = {
        ...
        # Add Confluence-specific required parameters
        "confluence_domain": parsed_args.confluence_domain,
        "confluence_email": parsed_args.confluence_email,
        "confluence_token": parsed_args.confluence_token,
        "confluence_page_ids": parsed_args.confluence_page_ids,
    }
...
if __name__ == "__main__":
    ...
    for arg_name, arg_value in vars(args).items():
        ...
        if arg_name in ["confluence_token"]:
            arg_value = "********" if arg_value else None
